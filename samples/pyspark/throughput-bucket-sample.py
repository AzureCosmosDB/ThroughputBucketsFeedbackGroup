...
# MAGIC to Bucket 1 using a server-side throughput bucket.
...
# MAGIC %md
# MAGIC **Write with throughput bucket 2**
# MAGIC
# MAGIC This example writes data with a throughput bucket 2.
# MAGIC
...
# MAGIC
# MAGIC This example uses bulk ingestion with a throughput bucket 2.

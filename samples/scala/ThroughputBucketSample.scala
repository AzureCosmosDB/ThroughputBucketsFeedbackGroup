...
// MAGIC to Bucket 3 using a server-side throughput bucket.
...
// MAGIC %md
// MAGIC **Write with throughput bucket 1**
// MAGIC
...
// MAGIC
// MAGIC This example uses bulk ingestion with a throughput bucket 3.
